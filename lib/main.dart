          ...
          GetMaterialApp(
            ...
            theme: ThemeData(
              ...
              textTheme:TextTheme(
                ...
                headline3: GoogleFonts.roboto(fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: -0.0, color: Colors.white),
                ...
                subtitle1: GoogleFonts.roboto(fontSize: 12, fontWeight: FontWeight.w400, letterSpacing: 0.1,  color: Colors.white),
                subtitle2: GoogleFonts.roboto(fontSize: 12, fontWeight: FontWeight.w400, letterSpacing: 0.1, color: Colors.blue),
