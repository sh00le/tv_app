...
class VodSerialDetailsPage extends StatelessWidget {
  ...
  final VodSerialDetailsPageController _controller =
      Get.put(VodSerialDetailsPageController());
                              ...
                              child: Row(
                                children: [
                                  ...
                                  FocusScope(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListView.builder(
                                        itemExtent: 40,
                                        itemCount: _
                                            .serialStatus.action.actions.length,
                                        itemBuilder: (context, index) {
                                          return FlatButton(
                                            autofocus:
                                                index == 0 ? true : false,
                                            focusColor:
                                                _style.actionFocusedColor,
                                            onPressed: () {
                                              debugPrint(
                                                  'pressed ${_.serialStatus.action.actions[index].title}');
                                              _.onActionSubmit(_.serialStatus
                                  ...
                                  FocusScope(
                                    ...
                                    child: GetBuilder<
                                        VodSerialDetailsPageController>(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${_.serialStatus.content.data.year} | ',
                                                        style:
                                                            textTheme.subtitle1,
                                                        textAlign:
                                                            TextAlign.start,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: _.serialStatus.content.data
                                                        .year !=
                                                    null
                                                ? IntrinsicHeight(
                                                    child: Row(children: [
                                          ...
                                          _.serialStatus.content.data
                                              ...
                                              : Container(),
                                          // Actors
                                          _.serialStatus.content.data.actors !=
                                                  null
                                              ? IntrinsicHeight(
                                                  child: Row(children: [
                                                    Container(
                                              ...
                                              : Container(),
                                          // Genre
                                          _.serialStatus.content.data.genre !=
                                                  null
                                              ? IntrinsicHeight(
                                                  child: Row(children: [
                                                    Container(
                          ...
                          builder: (_) => FocusScope(
                                ...
                                child: Container(
                                  ...
                                  child: AnimatedOpacity(
                                    opacity: _.serialStatus.episode.data.isEmpty
                                        ? 0.0
                                        : 1.0,
                                    duration: Duration(milliseconds: 400),
                                    child: _.serialStatus.episode.data.isEmpty
                                        ? Container()
                                        : TVInfiniteListView(
                                            controller: Get.find<
                                                    VodSerialDetailsPageController>()
                                            ...
                                            itemCount: _.serialStatus.episode
                                                .data.length,
                                            itemSize: 121,
                                            selectedItemIndex: 0,
                                            loop: false,
                                            itemBuilder:
                                              ...
                                              return ContentListItem(
                                                  item: _.serialStatus.episode
                                                      .data[index],
                                                  selected: isSelected);
                                            },
                                            onItemSelected: (selectedIndex) {
                                              _.onEpisodeSelected(_.serialStatus
                                                  .episode.data[selectedIndex]);
