...
class VodMovieDetailsPage extends StatelessWidget {
  ...
  final VodMovieDetailsPageController _controller =
      Get.put(VodMovieDetailsPageController());
                                    ...
                                    itemBuilder: (context, index) {
                                      return FlatButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          _.onActionSubmit(_.movieDetailsStatus
                                              .action.actions[index]);
                                        },
                                        child: Align(
                                            alignment: Alignment.centerRight,
                                            child: Text(
                                              _.movieDetailsStatus.action
                                                  .actions[index].title!,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                          ...
                                          children: [
                                            Text(
                                              '${_.vodMovie.displayDuration()} | ',
                                              style: textTheme.subtitle1,
                                              textAlign: TextAlign.start,
                                            ),
                                            Text(
                                              _.vodMovie.displayPrice(),
                                    ...
                                    Container(
                                      ...
                                      height: 160,
                                      child: Text(
                                        _.vodMovie.description != null
                                            ? _.vodMovie.description
                                            : '',
