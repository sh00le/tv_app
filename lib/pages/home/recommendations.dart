        ...
        child: GetBuilder<HomeController>(
          ...
          builder: (_) {
            return AnimatedOpacity(
              ...
              child: (_.homeStatus.recommendations.data.length == 0 || _.homeStatus.recommendations.widgetStatus == Status.hidden) ? Container() : TVInfiniteListView(
                ...
                itemBuilder: (context, index, selected) {
                  bool isSelected = (_.homeStatus.recommendations.focusScopeNode.hasFocus && selected) ? true : false;
                  return ContentListItem(item: _.homeStatus.recommendations.data[index], selected: isSelected);
                },
                onItemSelected: (selectedIndex) {
                  if (_.homeStatus.recommendations.focusScopeNode.hasFocus) {
